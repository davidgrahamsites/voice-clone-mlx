...
VoiceCloneMLX is a private, local-first macOS workspace for creating an
...
1. Read the [real round-trip procedure](procedure.html).
2. Record the [30-minute pilot script](recording-script.html).
...
For the complete repository map and commands, see the [README](README.html).
