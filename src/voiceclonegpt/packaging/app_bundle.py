...
via `python3 -m voiceclonegpt.<app>`.
...
MARKER_KEY = "VCGBuiltBy"
MARKER = "voiceclonegpt.packaging.app_bundle"
...
APP_SPECS: Dict[str, AppSpec] = {
    "voice_studio": AppSpec(
        ...
        module="voiceclonegpt.studio_app",
        bundle_id="com.voiceclonegpt.studio",
    ),
    "voice_reader": AppSpec(
        app_id="voice_reader",
        bundle_name="Voice Reader",
        module="voiceclonegpt.reader_app",
        bundle_id="com.voiceclonegpt.reader",
    ),
}
...
def build_launcher(spec: AppSpec, relative_repo: str) -> str:
    ...
    return (
        "#!/bin/sh\n"
        "# Generated by voiceclonegpt.packaging.app_bundle. Do not edit.\n"
        "set -eu\n"
